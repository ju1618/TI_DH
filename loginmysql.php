                            ...
                            <div class="mi-principal-form">
                                  <form role="form" class="" action="" method="post">
                                      ...
                                      <div class="form-group">
                                            <input type="text" name="email" value="" id="email" placeholder="Ingresa tu usuario..." class="form-control input_user" required >
                                            </div>
                                      </div>
                                      <div class="form-group">
                                            <input type="password" name="pass" value="" id="password" placeholder="Ingresa tu password..." class="form-control input_pass" required>
																						<i id="show-hide-passwd" action="hide" class="fas fa-eye-slash mi-check" aria-hidden="true">
        				                            </div>
                                      </div>
...
$db_user = "root";
$db_pass = '';
$db_name = "login"; //The database name is add here
