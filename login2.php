  ...
  require_once 'config.php';
	...
	if ($_POST) {
	    $user = $DB->getUserByEmail($_POST['email']);
			...
			if ( !$user ) {
				$loginValidator->setError('email', 'No hay usuario registrado con ese mail');
                            ...
                            <div class="mi-principal-form">
                                  <form role="form" class="" action="" method="post">
                                      ...
                                      <div class="form-group">
                                            <input type="text" name="email" value="<?= $loginValidator->getEmail() ?>" placeholder="Ingresa tu usuario..." class="form-control" id="email-form">
